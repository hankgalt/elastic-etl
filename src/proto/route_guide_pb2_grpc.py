...
from proto import route_guide_pb2 as proto_dot_route__guide__pb2
...
class RouteGuideStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFeature = channel.unary_unary(
                ...
                response_deserializer=proto_dot_route__guide__pb2.Feature.FromString,
                )
        self.ListFeatures = channel.unary_stream(
                '/routeguide.RouteGuide/ListFeatures',
                request_serializer=proto_dot_route__guide__pb2.Rectangle.SerializeToString,
                response_deserializer=proto_dot_route__guide__pb2.Feature.FromString,
                )
...
def add_RouteGuideServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetFeature': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=proto_dot_route__guide__pb2.Feature.SerializeToString,
            ),
            'ListFeatures': grpc.unary_stream_rpc_method_handler(
                    servicer.ListFeatures,
                    request_deserializer=proto_dot_route__guide__pb2.Rectangle.FromString,
                    response_serializer=proto_dot_route__guide__pb2.Feature.SerializeToString,
            ),
...
class RouteGuide(object):
    ...
    def GetFeature(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routeguide.RouteGuide/GetFeature',
            ...
            proto_dot_route__guide__pb2.Feature.FromString,
    ...
    def ListFeatures(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/routeguide.RouteGuide/ListFeatures',
            proto_dot_route__guide__pb2.Rectangle.SerializeToString,
            proto_dot_route__guide__pb2.Feature.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
